...
const TodoApp = ()=>(
	<div>
		...
		<p >Application version 6, use connect() from React_redux Lib, avoiding using context and subscribe/ unsubscribe to store in Components, cause connect() will handle it automatically </p>
